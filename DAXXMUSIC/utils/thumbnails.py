...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("DAXXMUSIC/assets/assets/font2.ttf", 0)
    font = ImageFont.truetype("DAXXMUSIC/assets/assets/font.ttf", 0)
    title_font = ImageFont.truetype("DAXXMUSIC/assets/assets/font3.ttf", 0)
